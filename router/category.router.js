...
//for getting the whole category array
router.get("/", (req, res) => {
  res.json({categories});
})

//for getting a particular category object whose id is added in url
...
//for adding a category object by passing the object in the request body
